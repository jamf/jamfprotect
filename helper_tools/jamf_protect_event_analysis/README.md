...
Resources contained within this repository can be leveraged in order to help you to optimize what system activity is monitored and which applications will be ignored by Threat Prevention.

The output generated by the provided python script can be used in order to start building [Exception Sets](https://docs.jamf.com/jamf-protect/documentation/Exceptions.html) within Jamf Protect.  
